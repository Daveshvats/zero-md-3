...
module.exports={
  ...
  exec(`ffmpeg -i ${media} ${ran}`, (err) => {
      ...
      client.sendMessage(m.from, { image: buffer,caption:'Zero-2022' }, { quoted: m })
      fs.unlinkSync(ran)
  })
  ...
  await client.sendMessage(m.from, { video: { url: webpToMp4.result, caption: 'Zero-2022' }, gifPlayback: true }, { quoted: m })
